...
gtex_filename       = '../data/gtex_preferential_tissue_expression_specific.tsv'
...
stats.to_csv('output/gtex_enrichment_of_de_genes.tsv', sep='\t', index=False)