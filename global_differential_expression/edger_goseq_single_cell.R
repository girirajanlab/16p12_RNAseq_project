...
anno = read.table('../tissue_expression2/cell_type_preferential_tissue_expression.tsv', header=T, sep='\t', stringsAsFactors = F)
...
write.table(go, 'output/no_sex/intersect.go.cell_type.tsv', sep='\t', row.names=F)
