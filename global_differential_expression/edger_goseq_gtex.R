...
anno = read.table('../tissue_expression2/gtex_preferential_tissue_enrichment.tsv', header=T, sep='\t', stringsAsFactors = F)
...
write.table(go, 'output/no_sex/intersect.go.gtex.tsv', sep='\t', row.names=F)