#!/usr/bin/env python3
# Modified from: https://github.com/broadinstitute/gtex-pipeline/blob/master/rnaseq/src/run_RSEM.py
...
with cd(args.output_dir):
    path = '/data5/anastasia/sw/'+ args.hostname+'/RSEM-1.2.22/'
    cmd = path +  'rsem-calculate-expression --num-threads '+args.threads+' --fragment-length-max '+args.max_frag_len+' --no-bam-output'
