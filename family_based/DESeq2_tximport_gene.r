#R pipeline for reading gene quantification data (Rsem) into R, and performing pairwise comparison of genes between samples using DeSeq2.
...
#PSU001
write.csv(as.data.frame(SG001_SG006), file="SG001_SG006_gene_deseq2.csv")
write.csv(as.data.frame(SG001_SG007), file="SG001_SG007_gene_deseq2.csv")
write.csv(as.data.frame(SG011_SG006), file="SG011_SG006_gene_deseq2.csv")
write.csv(as.data.frame(SG011_SG007), file="SG011_SG007_gene_deseq2.csv")
write.csv(as.data.frame(SG006_SG002), file="SG006_SG002_gene_deseq2.csv")
write.csv(as.data.frame(SG006_SG003), file="SG006_SG003_gene_deseq2.csv")

#PSU004
write.csv(as.data.frame(SG021_SG024), file="SG021_SG024_gene_deseq2.csv")
write.csv(as.data.frame(SG021_SG025), file="SG021_SG025_gene_deseq2.csv")
write.csv(as.data.frame(SG022_SG024), file="SG022_SG024_gene_deseq2.csv")
write.csv(as.data.frame(SG022_SG025), file="SG022_SG025_gene_deseq2.csv")
write.csv(as.data.frame(SG023_SG024), file="SG023_SG024_gene_deseq2.csv")
write.csv(as.data.frame(SG023_SG025), file="SG023_SG025_gene_deseq2.csv")

#PSU005
write.csv(as.data.frame(SG026_SG027), file="SG026_SG027_gene_deseq2.csv")
write.csv(as.data.frame(SG026_SG069), file="SG026_SG069_gene_deseq2.csv")
write.csv(as.data.frame(SG155_SG027), file="SG155_SG027_gene_deseq2.csv")
write.csv(as.data.frame(SG155_SG069), file="SG155_SG069_gene_deseq2.csv")
write.csv(as.data.frame(SG069_SG030), file="SG069_SG030_gene_deseq2.csv")
write.csv(as.data.frame(SG069_SG031), file="SG069_SG031_gene_deseq2.csv")

#PSU007
write.csv(as.data.frame(SG037_SG039), file="SG037_SG039_gene_deseq2.csv")
write.csv(as.data.frame(SG037_SG040), file="SG037_SG040_gene_deseq2.csv")
write.csv(as.data.frame(SG038_SG039), file="SG038_SG039_gene_deseq2.csv")
write.csv(as.data.frame(SG038_SG040), file="SG038_SG040_gene_deseq2.csv")
write.csv(as.data.frame(SG041_SG043), file="SG041_SG043_gene_deseq2.csv")
write.csv(as.data.frame(SG041_SG044), file="SG041_SG044_gene_deseq2.csv")
write.csv(as.data.frame(SG042_SG043), file="SG042_SG043_gene_deseq2.csv")
write.csv(as.data.frame(SG042_SG044), file="SG042_SG044_gene_deseq2.csv")
write.csv(as.data.frame(SG040_SG045), file="SG040_SG045_gene_deseq2.csv")
write.csv(as.data.frame(SG040_SG046), file="SG040_SG046_gene_deseq2.csv")
write.csv(as.data.frame(SG044_SG045), file="SG044_SG045_gene_deseq2.csv")
write.csv(as.data.frame(SG044_SG046), file="SG044_SG046_gene_deseq2.csv")

#PSU052
write.csv(as.data.frame(SG148_SG151), file="SG148_SG151_gene_deseq2.csv")
write.csv(as.data.frame(SG148_SG152), file="SG148_SG152_gene_deseq2.csv")
write.csv(as.data.frame(SG149_SG151), file="SG149_SG151_gene_deseq2.csv")
write.csv(as.data.frame(SG149_SG152), file="SG149_SG152_gene_deseq2.csv")
write.csv(as.data.frame(SG150_SG151), file="SG150_SG151_gene_deseq2.csv")
write.csv(as.data.frame(SG150_SG152), file="SG150_SG152_gene_deseq2.csv")
