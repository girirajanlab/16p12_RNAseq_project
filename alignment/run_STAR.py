#!/usr/bin/env python3
# Modified from: https://github.com/broadinstitute/gtex-pipeline/blob/master/rnaseq/src/run_STAR.py
...
parser.add_argument('--hostname', default=None, help='hostname (path depends on hostname)')
...
if read_length<=201:
    #/data5/anastasia/sw/qingyu/STAR-STAR_2.4.2a/bin/Linux_x86_64_static
    starcmd='/data5/anastasia/sw/%s/STAR-STAR_2.4.2a/bin/Linux_x86_64/STAR' % args.hostname
    starcmd='/data5/anastasia/sw/qingyu/STAR-STAR_2.4.2a/source/STAR'
else:
    starcmd='STARlong'
